/*
 * package com.ojas.obs.emp_edu.facadeImpl; import static
 ...
 * EmployeeEducationDetailsFacadeImplTest {
 * 
 * @InjectMocks EmployeeEducationDetailsFacadeImpl
 * employeeEducationDetailsFacadeImpl;
 * 
 * @Mock EmployeeEducationDetailsDaoImpl employeeEducationDetailsDaoImpl;
 * 
 ...
 * employeeEducationDetailsFacadeImpl = new
 * EmployeeEducationDetailsFacadeImpl(); employeeEducationDetailsDaoImpl =
 * mock(EmployeeEducationDetailsDaoImpl.class);
 * setCollaborator(employeeEducationDetailsFacadeImpl,
 * "employeeEducationDetailsDaoImpl", employeeEducationDetailsDaoImpl); }
 * 
 ...
 * when(employeeEducationDetailsDaoImpl.saveEmployeeEducationDetails(
 * empEduRequest)).thenReturn(count); ResponseEntity<Object> saveStatus =
 * employeeEducationDetailsFacadeImpl.setEmployeeEducationDetails(empEduRequest)
